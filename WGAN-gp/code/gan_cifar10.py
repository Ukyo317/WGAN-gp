...
ITERS = 80000 # How many generator iterations to train for
...
optimizerD = optim.RMSprop(netD.parameters(), lr=1e-4, alpha = 0.9)
optimizerG = optim.RMSprop(netG.parameters(), lr=1e-4, alpha = 0.9)
